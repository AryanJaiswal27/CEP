...
public class IssueAdapter extends ArrayAdapter<Issue> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        id.setText(String.format("Id: #%s", issue.getId()));
        ...
        upvote.setText(issue.getUpvotes() );
        downvote.setText( issue.getDownvotes());
        ...
        switch (severity) {
            case "high":
                ...
                break;
            case "medium":
                convertView.setBackgroundResource(R.drawable.yellow); // light yellow
                break;
            case "low":
                convertView.setBackgroundResource(R.drawable.green); // light green
                break;
            default:
